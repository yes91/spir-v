...
instance SpirEnum OpCode Word16 where
  ...
  requiredCapabilities OpImageQuerySizeLod = [Capability.Kernel, Capability.ImageQuery]
  requiredCapabilities OpImageQuerySize = [Capability.Kernel, Capability.ImageQuery]
  requiredCapabilities OpImageQueryLod = [Capability.ImageQuery]
  requiredCapabilities OpImageQueryLevels = [Capability.Kernel, Capability.ImageQuery]
  requiredCapabilities OpImageQuerySamples = [Capability.Kernel, Capability.ImageQuery]
